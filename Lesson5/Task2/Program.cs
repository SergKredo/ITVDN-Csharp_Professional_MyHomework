...
namespace Task2
{
    ...
    */
    class Program
    {
        ...
        {
            FileStream file = new FileStream(@"C:\Users\Work\Dropbox\Программирование на С#_ITVDN\csharp-professional-materials_homeworks\ITVDN-Csharp_Professional_MyHomework\Lesson5\Additional Task\bin\Debug\TelephoneBook.xml", FileMode.Open, FileAccess.Read);
            StreamReader text = new StreamReader(file, Encoding.UTF8);
            ...
            while (reader.Read())  // Считывание узла из потока
            {
                ...
                words = string.Format("Node Type: {0, -15}| Name: {1, -55}| Value: {2, -15}",
                    reader.NodeType, reader.Name, reader.Value)+"\r\n";
                builder.AppendFormat(words);
                Console.WriteLine(words);

                // Вывод данных атрибутов дочерних узлов
            ...
            File.WriteAllText(@"WriteXML.txt", builder.ToString());
        }
    }
}
