...
полученный результат в файл.*/
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)   // Бесконечный цикл для реализации повторного анализа данных страницы сайта
            {
                try
                {
                    ...
                    client.DownloadFile(@pageSite, @"site_data.txt"); // Вызов на экземпляре объекта типа WebClient метода DownloadFile. Метод загружает в локальный файл ресурс с указанным URI.
                    //Stream file = File.OpenRead(@"\http.txt");
                    //StreamReader fileStreamReader = new StreamReader(file, Encoding.UTF8);
                    Stream file = client.OpenRead(@pageSite); // Объект, открывает для чтения поток данных из файла
                    ...
                    // Регулярные выражения. Поиск всех встречающихся в тексте ссылок на другие сайты
                    string pattern = @"href='(?<link>\S+)'|src='(?<link>\S+)'";  // Задаем шаблон регулярного выражения для сопоставления с анализируемым массивом данных литералов.
                    ...
                    {
                        Regex regexTwo = new Regex(@"^http|www|//");  // Задаем поиск регулярного выражения
                        if (regexTwo.IsMatch(m.Groups["link"].Value))  // Условная конструкция, проверяет на соответствие условию шаблонного выражения
                        {
                    ...
                    // Регулярные выражения. Поиск всех встречающихся в тексте номеров телефонов
                    ...
                    // Проверка на совпадение номеров телефонов. Из коллекции с номерами удаляются все повторнообнаруженные номера телефонов
                    for (int j = 0; j < item.Count; j++)
                    {
                        for (int i = 0; i < removeIT.Count; i++)
                        {
                            try
                            {
                                pattern = @"\d+";  // Шаблон для поиска в строке одних цифр
                                regex = new Regex(pattern);
                                string word = removeIT[i].Replace("-", "").Replace("(", "").Replace(")", "").Replace(" ", "");  // Удаление из строки всех ненужных символов
                                word = regex.Match(word).Value;
                                word = word.Substring(word.Length - 7);  // Оставляем для анализа на совпадение только последнюю часть строки
                                ...
                                if (wordTwo.Contains(word))  // Анализ на совпадение строк
                                {
                                    try
                                    {
                                        inst.Add(word, i);  // Если номера телефонов совпали, то добавляем в коллекцию Dictionary<T> новый элемент с указанием ввиде значения индекса коллекции
                                    }
                                    catch { }  // Срабатывает, когда ключ с таким номером телефона содержится в словаре
                                }
                            }
                            catch { }
                        }
                    }
                    foreach (KeyValuePair<string, int> itom in inst)  // Перебор элементов коллекции
                    {
                    ...
                    // Регулярные выражения. Поиск всех встречающихся в тексте email
...
Link: http://www.nas.gov.ua/tradeunion/CentralCommittee/_layouts/15/Authenticate.aspx?Source=%2Ftradeunion%2FCentralCommittee%2FPages%2FCompositionCentralCommittee%2Easpx
----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Link: http://files.nas.gov.ua/photo/PersonalSite/DT/Onyshenko@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Onishchenko.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/DP/Sergiyenko@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Sergiyenko.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/DS/Skljarenko@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Sklyarenko.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/DP/Stogniy@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Stogniy.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/EW/Shevchenko.V.P@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/ShevchenkoVP.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/DP/Shestopalov@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Shestopalov.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/DT/Shidlovskiy@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Shidlovskiy.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/CU/Yukhnovskii@nas.gov.ua.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Yuhnovskiy.pdf
Link: http://files.nas.gov.ua/photo/PersonalSite/ET/MelnychukDO1943.jpg
Link: http://files.nas.gov.ua/text/DistributionDuties/Melnichuk.pdf
Link: http://www.nas.gov.ua/UA/About/Pages/history.aspx
Link: http://www.nas.gov.ua/UA/Presidium/Pages/default.aspx
Link: http://www.nas.gov.ua/UA/ApparatusPresidium/Pages/default.aspx
Link: http://www.nas.gov.ua/UA/Activity/PresidiumMeeting/Pages/default.aspx
Link: http://www.nas.gov.ua/UA/Conception/Pages/default.aspx
Link: http://www.nas.gov.ua/text/pdfNews/Donbass.pdf
Link: http://www.nas.gov.ua/UA/About/awards/Pages/default.aspx
Link: http://www.nas.gov.ua/UA/About/Pages/default.aspx
Link: https://www.facebook.com/NASofUkraine
Link: http://www.nas.gov.ua/UA/Pages/Default.aspx
Link: http://www.nas.gov.ua/UA/contacts/Pages/default.aspx
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002161
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002162
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002163
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002164
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002165
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002166
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002167
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002169
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002170
Link: http://www.nas.gov.ua/UA/NASUDepartment/Pages/default.aspx?DepartmentID=0002172
